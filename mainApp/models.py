...
class Brand(models.Model):
    ...
    pic = models.ImageField(
        upload_to="brands", default=None, null=True, blank=True)
...
class Buyer(models.Model):
    ...
    adressline1 = models.CharField(
        max_length=100, default="", null=True, blank=True)
    adresslin2 = models.CharField(
        max_length=100, default="", null=True, blank=True)
    adressline3 = models.CharField(
        max_length=100, default="", null=True, blank=True)
    ...
    pic = models.ImageField(
        upload_to="buyers", default="", null=True, blank=True)
...
orderStatus = ((1, "Order Placed"), (2, "Ready To Dispatch"),
               (3, "Dispatched"), (4, "Out For Delivery"), (5, "Delivered"))
